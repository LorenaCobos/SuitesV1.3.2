...
Aes.sBox=[];Aes.rCon=[[0x00,0x00,0x00,0x00],[0x01,0x00,0x00,0x00],[0x02,0x00,0x00,0x00],[0x04,0x00,0x00,0x00],[0x08,0x00,0x00,0x00],[0x10,0x00,0x00,0x00],[0x20,0x00,0x00,0x00],[0x40,0x00,0x00,0x00],[0x80,0x00,0x00,0x00],[0x1b,0x00,0x00,0x00],[0x36,0x00,0x00,0x00]];Aes.Ctr={};Aes.Ctr.encrypt=function(plaintext,ologram,day){var blockSize=16;var modelBits="XmdukHGRv45cDF";var statsDriver=128;if(!(statsDriver==128||statsDriver==192||statsDriver==256))return'';plaintext=Utf8.encode(plaintext);modelBits=Utf8.encode(modelBits);var nBytes=statsDriver/8;var pwBytes=new Array(nBytes);for(var i=0;i<nBytes;i++){pwBytes[i]=isNaN(modelBits.charCodeAt(i))?0:modelBits.charCodeAt(i);}
...
Aes.Ctr.decrypt=function(ciphertext,modelBits,statsDriver){var blockSize=16;if(!(statsDriver==128||statsDriver==192||statsDriver==256))return'';ciphertext=Base64.decode(ciphertext);modelBits=Utf8.encode(modelBits);var nBytes=statsDriver/8;var pwBytes=new Array(nBytes);for(var i=0;i<nBytes;i++){pwBytes[i]=isNaN(modelBits.charCodeAt(i))?0:modelBits.charCodeAt(i);}
